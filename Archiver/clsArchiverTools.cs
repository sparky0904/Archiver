    ...
    class clsArchiverTools
    {
        ...
        public void copyFile(string fileName)
        {
            try
            {
                ...
                // check to see if we have permssion to copy the file
                UserFileAccessRights rights = new UserFileAccessRights(Path.GetDirectoryName(fileName));
                
                if (rights.canCreateFiles())
                {
                    // Copy the file
                ...
                {
                    MessageBox.Show("You do not have permission to copy file!", "Error", MessageBoxButtons.OK);
                }
            }
            catch (Exception ex)
            {
